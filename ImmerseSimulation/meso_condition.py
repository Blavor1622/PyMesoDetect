...
"""
AREA_MINIMUM_THRESHOLD = 16
AREA_MAXIMUM_THRESHOLD = 135
NARROW_MAXIMUM_THRESHOLD = 3.25
AVG_VOLUME_MINIMUM_THRESHOLD = 2.65
DENSITY_MAXIMUM_THRESHOLD = 30
LAYER_GROUP_MAXIMUM_THRESHOLD = 1.75
LAYER_GROUP_MAXIMUM_COUNT_THRESHOLD = 4
...
def check_group_condition(echo_group, refer_img, layer_model_len):
    ...
    if not avg_layer_group_num <= LAYER_GROUP_MAXIMUM_THRESHOLD or not total_group_count <= LAYER_GROUP_MAXIMUM_COUNT_THRESHOLD:
        return False
    else:
        return True
